...
| Registry | Package |
|---|---|
| npm | `@particle-academy/facebook-lead-ads-js` (+ `@particle-academy/facebook-lead-ads-ui`, resolved transitively) |
...
npm install @particle-academy/facebook-lead-ads-js @particle-academy/fancy-flow
