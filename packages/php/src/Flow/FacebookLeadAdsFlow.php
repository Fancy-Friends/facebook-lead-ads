 ...
 */
/**
 * Every Facebook Lead Ads node executor — the PHP twin of
 * `FACEBOOK_LEAD_ADS_RUNNABLE_KINDS` in
 * @particle-academy/facebook-lead-ads-js.
 *
 * Each class declares its kind in a `#[FlowNode]` attribute. Two ways onto a
 * host:
 *
 * - `FacebookLeadAdsFlow::register($kinds, $executors)` — one call, no
 * directory scan.
 ...
 */
final class FacebookLeadAdsFlow
{
