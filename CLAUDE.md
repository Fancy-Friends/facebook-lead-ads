...
npm run provider -- facebook-lead-ads            # regenerate this repo
npm run provider -- facebook-lead-ads --check    # exit 1 on any difference
```
...
| `packages/ui` | `@particle-academy/facebook-lead-ads-ui` — the authoring surface, React, every host | Generated |
| `packages/js` | `@particle-academy/facebook-lead-ads-js` — Node, on `@particle-academy/fancy-connector-core` | Generated |
| `packages/php` | `particle-academy/facebook-lead-ads-php` — PHP 8.4, on `particle-academy/fancy-connector-core` | Generated |
| `packages/py` | `fancy-facebook-lead-ads` — Python 3.11+, stdlib only | Generated |

The authoritative copy of `provider/` lives in the weaver envelope at
`providers/facebook-lead-ads/provider/`. The copy here is emitted from it and `--check`
...
| | Namespace |
|---|---|
| This repo | `github.com/Fancy-Friends/facebook-lead-ads` |
| npm | `@particle-academy/facebook-lead-ads-ui`, `@particle-academy/facebook-lead-ads-js` |
| Packagist | `particle-academy/facebook-lead-ads-php` |
| PyPI | `fancy-facebook-lead-ads` |
...
**Default to plain HTTP.** A Facebook Lead Ads SDK is third-party code and is subject to
